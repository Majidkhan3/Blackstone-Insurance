...
const FloatingIcons = () => {
  return (
    <div className="fixed right-6 bottom-6 flex flex-col space-y-4 z-50">
      {/* WhatsApp Icon */}
      <a
        href="https://wa.me/917-487-9110"
        target="_blank"
        rel="noopener noreferrer"
        className="floating-icon w-16 h-16 rounded-full bg-green-500 flex items-center justify-center text-white shadow-lg hover:bg-green-600 transition-all duration-300"
