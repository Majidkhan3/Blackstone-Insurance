...
import { Shield, Zap, Lock, Award, CheckCircle, ArrowRight, Car } from 'lucide-react';
...
const CarInsurance = () => {
  const features = [
    {
      ...
      description: "Comprehensive coverage for all vehicle types with our elite protection matrix"
    },
    {
      icon: Zap,
      title: "Instant Claims",
      description: "Lightning-fast claim processing with our advanced AI-powered assessment system"
    },
    {
      icon: Lock,
      title: "Secure Coverage",
      description: "Bank-level security protocols protecting your policy and personal information"
    },
    {
      icon: Award,
      title: "Elite Benefits",
      description: "Exclusive perks including luxury rental cars and concierge services"
    }
  ];
  ...
  <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed mb-4">
    The <span className="text-[#00A1FC] font-semibold">Car Insurance</span> you need, 
    at the <span className="text-luxury">lowest prices</span>.
  </p>
  
  <p className="text-base md:text-lg text-gray-600 mb-6">
   Get the coverage you need at the lowest prices — compare instant quotes from 100+ top insurance companies for free.
  </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 animate-reveal-delay-1">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Advanced automotive insurance solutions powered by cutting-edge technology
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="animate-reveal">
              ...
              <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
                ...
                with luxury-grade coverage options tailored for discerning clients.
              </p>
            ...
            <div className="animate-reveal-delay-1">
              <div className="glass-card rounded-2xl p-8 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  <h3 className="text-2xl font-bold text-luxury mb-6">Premium Benefits</h3>
                  <ul className="space-y-4">
                    <li className="flex items-start space-x-3">
                      <CheckCircle className="w-5 h-5 text-matrix mt-0.5 flex-shrink-0" />
                      <span className="text-foreground">24/7 Concierge Claims Service</span>
                    </li>
                    <li className="flex items-start space-x-3">
                      <CheckCircle className="w-5 h-5 text-matrix mt-0.5 flex-shrink-0" />
                      <span className="text-foreground">Luxury Rental Car Program</span>
                    </li>
                    <li className="flex items-start space-x-3">
                      <CheckCircle className="w-5 h-5 text-matrix mt-0.5 flex-shrink-0" />
                      <span className="text-foreground">OEM Parts Guarantee</span>
                    </li>
                    <li className="flex items-start space-x-3">
                      <CheckCircle className="w-5 h-5 text-matrix mt-0.5 flex-shrink-0" />
                      <span className="text-foreground">Zero Deductible Glass Repair</span>
                    </li>
                  </ul>
                </div>
              </div>
